...
Lright=8; % CHANGE!!! % slightly larger than maximal meldting depth
...
TIC(indexExtrapolate) = 0.5*(TIC(indexExtrapolate-1)+TIC(indexExtrapolate+1));

% for iii = K1:K1-2
%     TIC(iii) = 0.5*(TIC(iii-1)+TIC(iii+1));
% end
% TIC(indexExtrapolate-2) = 0.
