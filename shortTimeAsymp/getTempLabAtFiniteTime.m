function [TempVec,hFinal,Linfty] = getTempLabAtFiniteTime( TimeFinal)
...
rhs = @(U)   getTermA(U, TimeFinal,Dconst,Linfty,maxRelError) ...
       ...
       spaceint = getTermA(Umean, TimeFinal,Dconst,Linfty,maxRelError)
       timeint = getTermB(Umean,TimeFinal,Dconst,alphaParam)
